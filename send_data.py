...
def main():
    ...
    rospy.Subscriber("/vrpn_client_node/LCJ_OTR_0409/pose", PoseStamped, vicon_pose_callback, queue_size=10)
    ...
    while not rospy.is_shutdown():
        ...
        if len(correct_debug_msg.data) == 8:
            rospy.loginfo_throttle(2, "%.4f,%.4f,%.4f,%.4f,%.4f,%.4f,%.4f,%.4f",correct_debug_msg.data[0],correct_debug_msg.data[1],correct_debug_msg.data[2],correct_debug_msg.data[3],correct_debug_msg.data[4],correct_debug_msg.data[5],correct_debug_msg.data[6],correct_debug_msg.data[7])
